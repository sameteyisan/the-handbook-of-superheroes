      ...
      children: [
        ...
        Obx(
          () => AnimatedCrossFade(
            ...
            crossFadeState:
                controller.featuredHeroes.isEmpty
        ...
        Obx(
          () => AnimatedScale(
            ...
            child: Row(
              ...
              children:
                  controller.featuredHeroes
                      .asMap()
                      .entries
                      .map(
                        (kv) => PageIndicator(isActive: kv.key == controller.currentCenter.value),
                      )
                      .toList(),
            ),
          ),
          ...
          child: Obx(
            () =>
                controller.lastHeroes.isEmpty
                    ? const Padding(padding: EdgeInsets.only(top: 32), child: EmptyWidget())
                    : ListView(
                      padding: const EdgeInsets.symmetric(vertical: 16),
                      physics: const BouncingScrollPhysics(),
                      shrinkWrap: true,
                      children:
                          controller.lastHeroes
                              .sublist(0, min(controller.lastHeroes.length, 3))
                              .map((superhero) {
                                return Padding(
